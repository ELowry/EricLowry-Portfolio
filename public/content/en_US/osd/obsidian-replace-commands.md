...
>
> - ⏱ Pending availability as a Community Plugin for Obsidian
> - 📦 [Download on GitHub](https://github.com/ELowry/obsidian-replace-commands/releases)
...
While editing and publishing over 300 articles for [CinQ on Medium](https://medium.com/odile-ai) in a shared Obsidian vault, I found myself heavily relying on regex to automate formatting, fixing recurring writing quirks, and cleaning up Markdown files. While there are plenty of search-and-replace tools out there, I couldn't find one that allowed me to easily sequence and chain multiple commands together.
...
Instead of running multiple, isolated search-and-replace queries one by one, Obsidian Replace Commands allows users to build and save a sequential chain of rules as single-click actions. It's built to be simple, flexible, and easy to configure:
